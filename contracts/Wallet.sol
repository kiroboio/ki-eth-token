...
contract Wallet is MultiSig {
    ...
    fallback () external payable multiSig2of3(msg.value) {
        ...
        assembly {
                ...
                let res := call(gas(), sload(s_target_slot), callvalue(), 0x00, calldatasize(), 0, 0)
    ...
    function transferOwnEther_(address payable to, uint256 value) public payable multiSig2of3(msg.value) {
        to.transfer(value);
