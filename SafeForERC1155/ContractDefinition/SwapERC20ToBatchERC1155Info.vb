...
Namespace KiEthToken.Contracts.SafeForERC1155.ContractDefinition
    ...
    Public Partial Class SwapERC20ToBatchERC1155Info
        Inherits SwapERC20ToBatchERC1155InfoBase
    End Class

    Public Class SwapERC20ToBatchERC1155InfoBase
        
        <[Parameter]("address", "token0", 1)>
        Public Overridable Property [Token0] As String
        <[Parameter]("uint256", "value0", 2)>
        Public Overridable Property [Value0] As BigInteger
        <[Parameter]("uint256", "fees0", 3)>
        Public Overridable Property [Fees0] As BigInteger
        <[Parameter]("address", "token1", 4)>
        Public Overridable Property [Token1] As String
        <[Parameter]("uint256[]", "tokenIds1", 5)>
        Public Overridable Property [TokenIds1] As List(Of BigInteger)
        <[Parameter]("uint256[]", "values1", 6)>
        Public Overridable Property [Values1] As List(Of BigInteger)
        <[Parameter]("bytes", "tokenData1", 7)>
